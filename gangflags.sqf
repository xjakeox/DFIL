...
if (_gangarea==gangarea1) then {_gangarea1 = "Emita Castle";};
if (_gangarea==gangarea2) then {_gangarea1 = "South District";};
if (_gangarea==gangarea3) then {_gangarea1 = "Roseyard";};
if (_gangarea==gangarea4) then {_gangarea1 = "Old Military Base";};
