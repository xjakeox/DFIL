	...
	class balca_btn_control_group : balca_debug_control_group {
		...
		//column 2
			...
			class balca_dance_btn : balca_debug_btn
			{
				...
				y = btn_height*4;
				text = "Dance 1";
				action = "[] execVM 'addons\proving_ground\fnc_dance.sqf'"; 
			};
			...
			class balca_dance2_btn : balca_debug_btn
			{
				...
				y = btn_height*5;
				text = "Dance 2";
				action = "[] execVM 'addons\proving_ground\fnc_dance2.sqf'"; 
			};
			...
			class balca_dance3_btn : balca_debug_btn
			{
				...
				y = btn_height*6;
				text = "Dance 3";
				action = "[] execVM 'addons\proving_ground\fnc_dance3.sqf'"; 
			};
			...
			class balca_money_btn : balca_debug_btn
			{
				...
				y = btn_height*9;
				text = "Comp Players";
				action = "[] execVM 'addons\proving_ground\comp.sqf'"; 
			};
