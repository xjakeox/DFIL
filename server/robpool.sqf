...
sleep 5;
if(robpoolsafe5 < maxinsafe)then{robpoolsafe5 = robpoolsafe5 + round random 2000; publicvariable "robpoolsafe5"};
sleep 5;
if(robpoolsafe6 < maxinsafe)then{robpoolsafe6 = robpoolsafe6 + round random 2000; publicvariable "robpoolsafe6"};
sleep 5;
if(robpoolsafe7 < maxinsafe)then{robpoolsafe5 = robpoolsafe7 + round random 2000; publicvariable "robpoolsafe5"};
sleep 10;
