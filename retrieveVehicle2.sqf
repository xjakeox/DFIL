...
reTrieve11 = player addaction [_rtv,"noscript.sqf",'continue = true; vehicle2Spawn = (INV_SavedVeh select 0);',1,true,true,"",'player distance savepoint2 < 5'];
reTrieve22 = player addaction [_rtv2,"noscript.sqf",'continue = true; vehicle2Spawn = (INV_SavedVeh select 1);',1,true,true,"",'player distance savepoint2 < 5'];
reTrieve33 = player addaction [_rtv3,"noscript.sqf",'continue = true; vehicle2Spawn = (INV_SavedVeh select 2);',1,true,true,"",'player distance savepoint2 < 5'];

player groupChat "[!] Retrieve Your Vehicle By Scrolling [!]";

waituntil {continue};

player removeAction reTrieve11;
player removeAction reTrieve22;
player removeAction reTrieve33;

player groupChat "-| Vehicle Retrieved |-";
...
action222 = player addaction ["Retrieve Saved Vehicle","retrievevehicle.sqf",[],1,false,true,"","player distance savepoint2 <= 3"];
};