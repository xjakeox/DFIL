...
_exitvar = 0;
if(TankenCost >= maxpetroluse)exitwith{player groupchat "Oil Import Price is too high therefore there is no Gas";};
...
if (not(['Mishy', -(TankenCost)] call INV_AddInvItem)) exitWith 
