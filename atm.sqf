...
CtrlSetText [101, format [localize "STRS_bank_dialog_inventarMishy", (_Mishy call ISSE_str_IntToStr)]];
CtrlSetText [102, format [localize "STRS_bank_dialoge_accountMishy",  (bnkgeld call ISSE_str_IntToStr)]];
