...
objects[] = { };
controls[] = {itemliste, itemeingabe, submit, cancel, weight, cancel2, submit2, itemeingabe2, itemliste2, text_inventarMishy, dummybutton};
	...
	class text_inventarMishy : RscText
