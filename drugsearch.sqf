...
format['if(!("trafficking drugs" in %1_reason))then{%1_reason = %1_reason + ["trafficking drugs"]}; %1_wanted = 1; kopfMishy_%1 = kopfMishy_%1 + (%2/2);titletext["%3 is wanted for trafficking $%2 worth of drugs!", "PLAIN"]', _civ, (_num*_cost)/2, name _civ] call broadcast;
