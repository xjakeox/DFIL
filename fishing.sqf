...
_airveh = ["kyo_ultralight","AH6X_EP1","KA137_PMC","CSJ_Gyroc","Mi17_Civilian","GazelleUN","Gazelle","Gazelle1","Gazelle3","adf_as350","ibr_as350_specops","ibr_as350_jungle","tcg_bell206_3","tcg_bell206_4","tcg_bell206_1","tcg_bell206_2","tcg_bell206_5","tcg_bell206", "MH6J_EP1"];
...
if(vehicle player iskindof "AIR") exitwith {player sidechat "You cannot fish in this vehicle!"};
if(typeof vehicle player in _airveh) exitwith {player sidechat "You cannot fish in this vehicle!"};
